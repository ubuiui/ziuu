...
stocks = {
    "예빈닉스": 71210, "지유엔터": 86792, "헬프미": 73118, 
    "명철수산": 72068, "찬우상사": 69553, "예원데이터": 65153, "만상인터넷": 75057,
    "민지유건설": 54333, "피브테크": 62367, "루카드림": 46697, "우뱅미디어": 44220,
    "어둠반도체": 62292, "여름전자": 80175, "해나물류": 71942, "헤응인터내셔널": 76167,
    "여름에셋": 55764, "루카파트너스": 64785, "예빈홀딩스": 75734, "지유인베스트": 87645,
    "만상캐피탈": 76546, "헤응스튜디오": 86645, "명철푸드": 67886, "민지유커뮤니케이션": 87775,
    "예빈모터스": 67578, "피브정밀": 76665, "어둠에너지": 76854, "우뱅제약": 88888, "예빈메디컬": 57678,
    "루카바이오": 75756, "만상로보틱스": 75475, "예원콘텐츠": 44577, "헬프픽처스": 46574, "우뱅브랜딩": 76576
}
...
# --- 관리자 전용 : 상장폐지 강제 실행 ---
@bot.command(name="상장폐지")
@commands.has_permissions(administrator=True)
async def 상장폐지(ctx, name: str):
    if name not in stocks:
        return await ctx.send(f"❌ {name}은(는) 현재 시장에 없는 주식입니다.")
